...
def viewboard(state, boards_played, p1=1, p2=2):
    ...
    return (False, key, trans_number)


def diffuse(state, p1=1, p2=2):
...
class Test_EvalBoard(unittest.TestCase):
    def test_diffuse(self):
        ...
        self.assertListEqual(diffuse(board, p1=1, p2=2).tolist(),
                             known_util.tolist(),
                             )
        ...
        test_util = diffuse(board, p1=1, p2=2)
    ...
    def test_tuple_to_nd3(self):
        ...
        self.assertListEqual(expected.tolist(), found.tolist())
